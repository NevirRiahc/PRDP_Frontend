<template>
   <div class="app-container">
      ...
      >
         ...
         <el-table-column prop="orderNum" label="OrderNum" width="200"></el-table-column>
         <el-table-column prop="status" label="Status" width="100">
            <template #default="scope">
               <dict-tag :options="sys_normal_disable" :value="scope.row.status" />
            </template>
         </el-table-column>
         <el-table-column label="CreateTime" align="center" prop="createTime" width="200">
            <template #default="scope">
         ...
         <el-table-column label="Operation" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:dept:edit']">Update</el-button>
            ...
            <el-row>
               ...
               <el-col :span="12">
                  <el-form-item label="Department Name" prop="deptName">
                     <el-input v-model="form.deptName" placeholder="Department name" />
                  </el-form-item>
               </el-col>
               <el-col :span="12">
...
function handleDelete(row) {
  proxy.$modal.confirm('Do you want to delete the name as"' + row.deptName + '"data item?').then(function() {
