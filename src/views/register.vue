<template>
  <div class="register">
    <el-form ref="registerRef" :model="registerForm" :rules="registerRules" class="register-form">
      <h3 class="title">PRDP Register</h3>
      ...
      <el-form-item style="width:100%;">
        ...
        >
          ...
          <span v-else>be registering...</span>
        </el-button>
...
const registerRules = {
  ...
  confirmPassword: [
    ...
    { required: true, validator: equalToPassword, trigger: "blur", message: "Passwords do not match" }
  ],
  ...
  proxy.$refs.registerRef.validate(valid => {
    if (valid) {
      ...
      register(registerForm.value).then(res => {
        ...
        ElMessageBox.alert("<font color='red'>Congratulations on your account " + username + " registered successfully！</font>", "System prompt", {
