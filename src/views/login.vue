...
const loginRules = {
  username: [{ required: true, trigger: "blur", message: "Please enter your account number" }],
  password: [{ required: true, trigger: "blur", message: "Please enter your password" }],
  code: [{ required: true, trigger: "change", message: "Please enter your captcha" }]
};
